...
const Platform = () => {
  return (
    <div className="bg-Linen xl:pt-[130px] lg:pt-[100px] md:pt-20 sm:pt-16 pt-12">
      <div className="max-w-[1514px] mx-auto 2xl:px-0 px-5  bg-[url(./assets/images/png/bg_lines.png)] bg-cove bg-no-repeat bg-bottom g-[length:100%_100%]">
        ...
        <div className="flex md:flex-row flex-col md:justify-between gap-6 md:items-end sm:pb-[230px] pb-[150px] xl:me-[37px]">
          <div className="md:w-5/12 ps-1 md:mb-2">
            <img
              className="xl:w-auto w-[200px] md:mx-0 mx-auto md:pe-0 pe-20"
              src={left_arrow}
              alt="arrows"
            />
            <div className="min-[500px]:flex justify-center">
              <div className="sm:pt-9 sm:ps-10 xl:pe-[110px] sm:pe-20 sm:pb-6 p-6 bg-[#FCF0D7] rounded-[20px] sm:inline-block">
            ...
            <div className="grid min-[500px]:grid-cols-2 min-[1400px]:gap-x-[125px] xl:gap-x-20 lg:gap-12 md:gap-3 gap-6 xl:gap-y-[58px]">
              {allPlateforme.map((obj, index) => {
                return (
                  <div
                    key={index}
                    className="rounded-[20px] lg:h-[296px] bg-white lg:px-9 lg:pt-9 lg:pb-6 sm:p-4 pt-6 ps-7 pe-4 pb-4  relative shadow-[0px_4px_4px_0px_#0000001F] hover:shadow-[0px_4px_4px_0px_#fff] transition-all duration-300
"
                  >
